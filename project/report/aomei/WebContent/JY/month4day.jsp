...
<html>
 ...
 <body> 
    ...
    var json_data={
            "NAME"  : "挤压日总报工",
            "SUBNAME"  : "机台日总产量",
            "SQL"   :  "select C_TIME , sum(BEFWEI_FLOAT)  as BEFWEI_FLOAT from \"_SYS_BIC\".\"aomei.prod/ZPPPR_KANBAN_BG\"  where  YYYYMM =201706 group by C_TIME order by C_TIME ",
            "ITEMS" : "报工数量",
            "X":"C_TIME",
            "Y":"BEFWEI_FLOAT",
            "UNITS":"1000",
    ...
    var myChart = echarts.init(document.getElementById('main'));
	    ...
	    $.ajax({
	    	...
	    	url:"http://172.17.10.226:8181/api/Echart_Line",
	    	type: "POST",
